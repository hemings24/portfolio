...
<div class="col-md-12">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <aside id="admin_sidebar" class="col-md-4">
         ...
         <div class="form-group">
            ...
            <select name="product_cat_id" id="" class="form-control">
               <option value="<?php echo $_SESSION['prod_product_cat_id'] ?>">
                  <?php echo empty($_SESSION['prod_product_cat_id']) ? "Select Category" : show_product_category_title($_SESSION['prod_product_cat_id']); ?>
               </option>
         ...
         <div class="form-group">
            <input type="submit" name="submit" class="btn btn-primary btn-lg" value="Add Product">
         </div>
